...
function goMainMenu() {
    settingsSection.style.display = resultsSection.style.display = errorSection.style.display = "none";
...
settingsButton.addEventListener("click", () => {
    inputSection.style.display = resultsSection.style.display = errorSection.style.display = "none";
...
verifyButton.addEventListener("click", () => {
    ...
    resultsSection.style.display = errorSection.style.display = verifyButton.style.display = "none";
    ...
    fetch(url)
        ...
        .then((data) => {
            if (data.invoices.length > 0) {
                ...
                packageDate.textContent = moment(data.invoices[0].date).format('dddd, MMMM Do, YYYY');
